...
public class Trefoil2Test {
    ...
    @Test
    public void testPlusParsing() {
        assertEquals(new Expression.Plus(Expression.ofInt(3), Expression.ofInt(17)),
    ...
    public void testMinusParsing() {
        assertEquals(new Expression.Minus(Expression.ofInt(3), Expression.ofInt(17)),
                Expression.parseString(
                        "(- 3 17)"));
    }
    ...
    public void testMinusTypeError() {
        assertEquals(Expression.ofInt(3),
                Interpreter.interpretExpression(Expression.parseString("(- 1 false)")));
    }
    ...
    @Test(expected = Trefoil2.TrefoilError.AbstractSyntaxError.class)
    public void testMinusMoreArg() {
        Interpreter.interpretExpression(Expression.parseString("(- 1 2 3)"));
    }
    ...
    public void testTimesParsing() {
        assertEquals(new Expression.Times(Expression.ofInt(3), Expression.ofInt(17)),
                Expression.parseString(
                        "(* 3 17)"));
    }
    ...
    public void testEqualsIntTrue() {
        ...
        assertEquals(Expression.ofBoolean(true),
                Interpreter.interpretExpression(Expression.parseString("(= 3 (- 5 2))")));
        assertEquals(Expression.ofBoolean(true),
                Interpreter.interpretExpression(Expression.parseString("(= 8 (* 2 4))")));
    }
    ...
    @Test
    public void testEqualsParsing() {
        assertEquals(new Expression.Equal(Expression.ofInt(3), Expression.ofInt(17)),
                Expression.parseString(
                        "(= 3 17)"));
    }
    ...
    @Test
    public void testIfParsing() {
        assertEquals(new Expression.If(Expression.ofBoolean(false), Expression.ofInt(0),
                        Expression.ofInt(5)),
                Expression.parseString("(if false 0 5)"));
    }
    ...
    @Test(expected = Trefoil2.TrefoilError.AbstractSyntaxError.class)
    public void testIfWrongArgs() {
        assertEquals(Expression.ofBoolean(false),
                Interpreter.interpretExpression(Expression.parseString("(if 4 1)")));
        assertEquals(Expression.ofBoolean(false),
                Interpreter.interpretExpression(Expression.parseString("(if 4 x y z)")));
    }
    ...
    public void testIfNil() {
        assertEquals(new Expression.BooleanLiteral(false),
                Interpreter.interpretExpression(Expression.parseString("(nil? 2)")));
        assertEquals(new Expression.BooleanLiteral(true),
    ...
    public void testIfCons() {
        ...
        assertEquals(new Expression.BooleanLiteral(false),
                Interpreter.interpretExpression(Expression.parseString("(cons? nil)")));
    }
    ...
    @Test
    public void testFuncBinding() {
//        assertEquals(new Interpreter.DynamicEnvironment.Entry.FunctionEntry("f", Expression.parseString("(+ x 1)")),
//                Interpreter.interpretBinding(Binding.parseString( "(define (f x) (+ x 1))")));
    }
    ...
    @Test
    public void testTestBindingParsing() {
        assertEquals(new Binding.TestBinding(new Expression.Equal(Expression.ofInt(3),
                        Expression.ofInt(17))),
                Binding.parseString("(test (= 3 17))"));
    }
